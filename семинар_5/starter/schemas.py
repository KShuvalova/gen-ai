...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Сравнить одну макроэкономическую метрику в двух периодах. "
                "Использовать, когда вопрос просит сравнить курс валюты, "
                "ключевую ставку, инфляцию или безработицу между двумя датами."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "metric": {
                        "type": "string",
                        "description": (
                            "Метрика: key_rate, fx_USD, fx_EUR, fx_CNY, "
                            "cpi, unemployment"
                        ),
                        "enum": [
                            "key_rate",
